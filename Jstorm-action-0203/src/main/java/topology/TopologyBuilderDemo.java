...
import bolt.CalcluateGeThanBolt;
import bolt.CalcluateLessThanBolt;
import bolt.ClassifyBolt;
...
public class TopologyBuilderDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("calcluateGeThanBolt",new CalcluateGeThanBolt(1, "随机大于等于50"), 1).setNumTasks(1)
